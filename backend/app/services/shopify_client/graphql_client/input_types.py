...
class BlogUpdateInput(BaseModel):
    ...
    title: Optional[str] = None
    redirect_new_handle: Optional[bool] = Field(alias="redirectNewHandle", default=None)
    redirect_articles: Optional[bool] = Field(alias="redirectArticles", default=None)
...
class DiscountCustomerBuysInput(BaseModel):
    ...
    is_subscription: Optional[bool] = Field(alias="isSubscription", default=None)
...
class GiftCardRecipientInput(BaseModel):
    ...
    message: Optional[str] = None
    send_notification_at: Optional[Any] = Field(
...
class MarketCurrencySettingsUpdateInput(BaseModel):
    ...
    base_currency_manual_rate: Optional[Any] = Field(
...
class OrderCreateOptionsInput(BaseModel):
    ...
    send_receipt: Optional[bool] = Field(alias="sendReceipt", default=None)
...
class OrderCreateOrderInput(BaseModel):
    ...
    closed_at: Optional[Any] = Field(alias="closedAt", default=None)
    company_location_id: Optional[str] = Field(alias="companyLocationId", default=None)
    currency: Optional[CurrencyCode] = None
    ...
    processed_at: Optional[Any] = Field(alias="processedAt", default=None)
    referring_site: Optional[Any] = Field(alias="referringSite", default=None)
    shipping_address: Optional["MailingAddressInput"] = Field(
        alias="shippingAddress", default=None
    )
    ...
    source_name: Optional[str] = Field(alias="sourceName", default=None)
    source_url: Optional[Any] = Field(alias="sourceUrl", default=None)
    tags: Optional[list[str]] = None
    taxes_included: Optional[bool] = Field(alias="taxesIncluded", default=None)
    tax_lines: Optional[list["OrderCreateTaxLineInput"]] = Field(
        alias="taxLines", default=None
    )
...
class OrderCreateOrderTransactionInput(BaseModel):
    ...
    location_id: Optional[str] = Field(alias="locationId", default=None)
    processed_at: Optional[Any] = Field(alias="processedAt", default=None)
    receipt_json: Optional[Any] = Field(alias="receiptJson", default=None)
...
class OrderCreateTaxLineInput(BaseModel):
    channel_liable: Optional[bool] = Field(alias="channelLiable", default=None)
    price_set: Optional["MoneyBagInput"] = Field(alias="priceSet", default=None)
    rate: Any
    title: str
